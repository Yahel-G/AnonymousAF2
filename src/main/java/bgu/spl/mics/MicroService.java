...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        daBus.subscribeEvent(type, this);
        callbackMap.put(type, callback); // what if the event is already in the map? could that happen?
    }
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
        daBus.subscribeBroadcast(type, this);
        callbackMap.put(type, callback); // what if the broadcast is already in the map? could that happen?
    }
